...
gcloud ai-platform jobs submit training $run_name --config gcloud_config.yaml --region 'europe-west4' --master-image-uri eu.gcr.io/your-project-name/your-image-name -- \ --run-name $run_name --dataset ./data/$dataset --reuse-weights False --checkpoint 0009799 --filter --categories "total_loss" "other" "dent" "shatter" --area 500 --combine "scratch" "rust_main"
