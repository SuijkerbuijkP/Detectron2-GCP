...
gcloud ai-platform jobs submit training $run_name --config eval_gcloud_config.yaml --region 'europe-west4' --master-image-uri eu.gcr.io/your-project-name/your-image-name -- \ --run-name $run_name --dataset ./data/$dataset_name --checkpoint $checkpoint --eval-name $eval_name
