...
if __name__ == "__main__":
    ...
    # register dataset
    register_coco_instances("car_damage_train", {}, "./exc_onlysinglerust_train.json", "./exc_onlysinglerust_images")
    ...
    for s in ["exc_onlysinglerust_train", "exc_onlysinglerust_val"]:
        create_coco_semantic_from_instance(
            os.path.join(dataset_dir, "{}.json".format(s)),
            os.path.join(dataset_dir + "exc_onlysinglerust_images", "thing_train".format(s)),
